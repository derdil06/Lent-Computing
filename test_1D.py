...
def test_rivers_with_station():
    ...
    stations = [ #fake station names
        MonitoringStation("id1", "m1", "s1", (0, 0), (0, 1), "River Cam", "Town1"),
        MonitoringStation("id2", "m2", "s2", (0, 0), (0, 1), "River Cam", "Town2"),
        MonitoringStation("id3", "m3", "s3", (0, 0), (0, 1),"River Thames", "Town3"),]
...
def test_stations_by_river():
    ...
    s1 = MonitoringStation("id1", "m1", "Cambridge", (0, 0),(0, 1), "River Cam", "Cambridge")
    s2 = MonitoringStation("id2", "m2", "Jesus Lock", (0, 0),(0, 1), "River Cam", "Cambridge") #i miss rowing on the cam :/
    s3 = MonitoringStation("id3", "m3", "Oxford", (0, 0),(0, 1), "River Thames", "Oxford")
    stations = [s1, s2, s3]
